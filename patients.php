...
<div class="col-sm-6">
<div class="band">
<h3><strong>This is My Sample Web Page</strong></h3>
</div>
<p>This is a standard web page that is created for new users. Your
web pages are located in your "www" folder in your home directory.
This file is "index.html". To edit your web page, open this file
with any web page editing software. Macromedia Dreamweaver and
Microsoft FrontPage are available on all ITaP lab PCs. All web
files should be placed in the www folder on your Purdue Career
Account.</p>
<p>Your web page address is:
<i>http://web.ics.purdue.edu/~g1100782/</i></p>
</div>
</div>
<div class="row">
<div class="col-sm-12">
<div class="band">
<h3><strong>About Your Career Account Web Space</strong></h3>
</div>
</div>
<div class="col-sm-4">
<div class="subgrey">
